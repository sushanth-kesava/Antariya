...
async function buildStyledWelcomeMessage({ email, displayName }) {
  ...
  message.html = message.html
    ...
    .replace(
      /<div style="font-size:11px;color:#8a8a8a;margin-top:22px;">&copy; 2026 \${safeAppName} reverse the trend\. All rights reserved\.<\/div>/,
      '<div style="font-size:14px;color:#fff;margin-top:20px;">&copy; 2026 ${safeAppName} reverse the trend. All rights reserved.</div>'
    )
    .replace(
