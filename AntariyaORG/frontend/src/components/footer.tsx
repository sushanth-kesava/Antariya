...
const PUBLIC_SECTIONS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Dealer Program", href: "/portal/superadmin" },
...
const FOOTER_COPY: Record<FooterVariant, { title: string; description: string; links: Array<{ label: string; href: string }>; note: string }> = {
  ...
  admin: {
    ...
    links: [
      { label: "Operations Overview", href: "/portal/superadmin/admin/operations-overview" },
      { label: "Catalog", href: "/portal/superadmin/admin/my-company-catalog" },
      { label: "Reviews", href: "/portal/superadmin/admin/review-moderation" },
    ],
    note: "Admin workspace for dealer and catalog management.",
  },
  superadmin: {
    title: "Admin Portal (Seller)",
    description: "Seller dashboard — manage your products, inventory and orders.",
    links: [
      { label: "Seller Dashboard", href: "/portal/superadmin/admin" },
      { label: "Catalog", href: "/portal/superadmin/admin/my-company-catalog" },
      { label: "Customer Portal", href: "/portal/customer" },
    ],
    note: "Seller-facing admin tools for managing the storefront.",
  },
};
