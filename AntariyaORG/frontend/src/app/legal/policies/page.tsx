  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <p><span className="font-semibold text-foreground">12.</span> Shipping charges, platform fees, COD charges, convenience fees, or other non-product service charges may not be refundable unless the error was caused directly by Antariya.</p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <p>Antariya reserves the right to deny COD services, restrict payment methods, or limit transaction access for specific locations, products, users, or risk-based situations.</p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <p><span className="font-semibold text-foreground">7.</span> Customers are prohibited from placing fake orders, intentionally refusing deliveries, abusing COD services, manipulating refunds, or exploiting promotional campaigns unfairly.</p>
